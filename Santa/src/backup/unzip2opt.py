...
MIN_PASS_IMPROVEMENT = 1000  # must be >0; 1000 gets ~99% of possible improvement with this data
    ...
    def tour_update_generator(self):
        ...
        for node1 in node_generator:  
            ...
            for node3 in TourEngine.neighbors[node1].id:  # sorted by distance
                ...
                if dist13 > dist12:  # Much faster (3x-10x), but path length is ~1% more 
                   break  
...
def main():
    ...
    updater = tour2.tour_update_generator()
    ...
    while IMPROVING:
        ...
        ecounts = tour1.get_edge_counts()[1]
        print "edges:", ecounts
        sys.stdout.flush()
