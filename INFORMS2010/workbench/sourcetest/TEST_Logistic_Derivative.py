...
#dataDescription = [ [  normCenter, gradientVars, var74Selector, normCenter, floatDataGetter ] ] 
#dataDescription = [ [  var74Selector, normCenter, floatDataGetter ] ] 
dataDescription  = [ [  normCenter, gradientVars, var74Selector, normCenter, floatDataGetter ],\
                     [  var74Selector, normCenter, floatDataGetter ]   ]

print "Transforming data"
transformedData = transformData(dataDescription)
trainMask = numpy.isfinite(targetVariable)
gradTargetVariable = numpy.copy(targetVariable)
gradTargetVariable[trainMask] = numpy.gradient(targetVariable[trainMask])
...
print "TESTING sweep" 
sweepRegularization(regRangeTuple, classifier, transformedData, gradTargetVariable, \
