...
def getDataTransform(dataTransformName, providedDataObject):
    ...
    var167PriceSelector = makeSelectVars(["Variable167LAST"])
    ...
    # October 8th Price Regression experiments
    d['Oct8PriceRegressionPrices'] = [[ \
        [ makeVarSelectLag("Variable74LOW", 13),        getFloatPriceVars],\
        [ makeVarSelectLag("Variable74HIGH", 1),        getFloatPriceVars],\
        [ makeVarSelectLag("Variable74LAST_PRICE", 12), getFloatPriceVars],\
        [ makeVarSelectLag("Variable74LAST_PRICE",  0), getFloatPriceVars],\
        [ makeVarSelectLag("Variable167LAST", 12),      getFloatPriceVars],\
        [ makeVarSelectLag("Variable167LAST",  0),      getFloatPriceVars] \
        ]]
    # used above to save to a file Oct8PriceRegressionPrices.dat, 
    # next use --loadtdata to reload the data & apply the following --transform(s): 
    d['Oct8passthruVars']   = [[[passthruVars,   normCenter ]]]
    d['Oct8pct']            = [[[percentileVars ]]]
    d['Oct8periodNorm']     = [[[makePeriodNorm(timestamps), normCenter ]]]
    d['Oct8pctPeriodNorm']  = [[[percentileVars, makePeriodNorm(timestamps), normCenter]]]

    d['Oct8trial'] =  [[[normCenter, varPriceLags0, var74PriceSelector, getFloatPriceVars],\
                        [normCenter, varPriceLags1, var74PriceSelector, getFloatPriceVars],\
                        [normCenter, varPriceLags0, var167PriceSelector, getFloatPriceVars]]]
    d['Oct8catCat'] = [[[normCenter, getCategoricalVars], [passthruVars, normCenter]]]
    



    d['Oct8trialpn']= [[[periodNorm, normCenter, varPriceLags0, var74PriceSelector, getFloatPriceVars],\
                        [periodNorm, normCenter, varPriceLags1, var74PriceSelector, getFloatPriceVars],\
                        [periodNorm, normCenter, varPriceLags0, var167PriceSelector, getFloatPriceVars]]]


    d['Oct8trialpctpn']= [[[percentileVars, periodNorm, normCenter, varPriceLags0, var74PriceSelector, getFloatPriceVars],\
                        [percentileVars, periodNorm, normCenter, varPriceLags1, var74PriceSelector, getFloatPriceVars],\
                        [percentileVars, periodNorm, normCenter, varPriceLags0, var167PriceSelector, getFloatPriceVars]]]

    d['Oct8trialpct']= [[[percentileVars,  normCenter, varPriceLags0, var74PriceSelector, getFloatPriceVars],\
                        [percentileVars,  normCenter, varPriceLags1, var74PriceSelector, getFloatPriceVars],\
                        [percentileVars,  normCenter, varPriceLags0, var167PriceSelector, getFloatPriceVars]]]
