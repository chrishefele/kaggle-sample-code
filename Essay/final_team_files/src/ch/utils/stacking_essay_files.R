...
target_file_VAL  <- paste(dropbox_root,'valid_set.tsv',sep="")
target_file_VAL1 <- paste(dropbox_root,'valid_set_TEST.tsv',sep="")

#this is wherever the combined file goes
combined_file_VAL <- paste('valid_set_COMBINED.tsv',sep="")
