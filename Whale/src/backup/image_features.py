...
THUMB_X = 64 # thumbnail dimentions
THUMB_Y = 64
...
def parseCommandLine():
    ...
    parser.add_argument('--histogram',  action='store_true', help='make pixel value histogram feature')
    parser.add_argument('--pixels',     action='store_true', help='make pixel value features')
    parser.add_argument('--randseed',   type=int, help='set RNG seed')
    parser.add_argument('--thumb_size', type=int, help='thumbnail size in pixels (both x & y) ')
    parser.add_argument('--thumb_dir',  type=str, help='dir to write thumbnails to')
